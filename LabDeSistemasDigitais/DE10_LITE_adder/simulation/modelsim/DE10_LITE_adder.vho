...
SIGNAL \adder0|fa1|Mux0~0_combout\ : std_logic;
SIGNAL \adder0|fa1|co~0_combout\ : std_logic;
...
\adder0|fa1|Mux0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \adder0|fa1|Mux0~0_combout\ = \SW[1]~input_o\ $ (\SW[5]~input_o\ $ (((\SW[0]~input_o\ & \SW[4]~input_o\))))
...
PORT MAP (
	...
	datac => \SW[5]~input_o\,
	datad => \SW[4]~input_o\,
	combout => \adder0|fa1|Mux0~0_combout\);

-- Location: LCCOMB_X51_Y53_N12
\adder0|fa1|co~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \adder0|fa1|co~0_combout\ = (\SW[1]~input_o\ & ((\SW[5]~input_o\) # ((\SW[0]~input_o\ & \SW[4]~input_o\)))) # (!\SW[1]~input_o\ & (\SW[0]~input_o\ & (\SW[5]~input_o\ & \SW[4]~input_o\)))
...
PORT MAP (
	...
	datac => \SW[5]~input_o\,
	datad => \SW[4]~input_o\,
	combout => \adder0|fa1|co~0_combout\);
...
-- Equation(s):
-- \adder0|fa2|Mux0~0_combout\ = \adder0|fa1|co~0_combout\ $ (\SW[2]~input_o\ $ (\SW[6]~input_o\))
...
-- Equation(s):
-- \adder0|fa3|Mux0~1_combout\ = \adder0|fa3|Mux0~0_combout\ $ (((\adder0|fa1|co~0_combout\ & ((\SW[2]~input_o\) # (\SW[6]~input_o\))) # (!\adder0|fa1|co~0_combout\ & (\SW[2]~input_o\ & \SW[6]~input_o\))))
